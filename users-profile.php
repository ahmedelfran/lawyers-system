...
if (isset($_POST['update'])){
  ...
  $update = "UPDATE `admin` SET name = '$name' , email = '$email' , password = ' $password' , image = '$image_name'   where id = $adminid";
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Upload New Image</label>
                    <div class="col-md-8 col-lg-9">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="password" type="password" class="form-control" id="company" value="<?php echo $row['password']?>">
                    </div>
                  </div>
